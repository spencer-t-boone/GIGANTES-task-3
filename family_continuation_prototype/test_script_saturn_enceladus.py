...
#   then continue L2 halo orbit family, detect bifurcation with butterfly orbits (4th period-doubling), continue butterfly orbit family
...
test = validation_case_options[6]
test = additional_test_case_options[4]
